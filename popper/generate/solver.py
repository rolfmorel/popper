...
class SolverMixin(object):
    def __init__(self, *args, **kwargs):
        ...
        self.context.solver.add_child('size_grounding')
        self.context.solver.add_child('get_model')
